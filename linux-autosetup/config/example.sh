...
App file-roller
App firefox "" "COPY" "$HOME/.mozilla/firefox/PROFILE"
App flatseal "flatpak install flathub com.github.tchx84.Flatseal"
...
# Runs any commands the specified in the function on these specific events
